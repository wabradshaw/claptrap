...
object JokeSuggestions : Table() {
    ...
    val oldPrimaryRelationship : Column<String> = varchar("oldPrimaryRelationship", length=32) // How the primary setup links to the nucleus in the original joke
    val oldSecondaryRelationship : Column<String> = varchar("oldSecondaryRelationship", length=32) // How the secondary setup links to the linguistic replacement in the original joke
    ...
    val newPrimaryRelationship : Column<String> = varchar("newPrimaryRelationship", length=32) // How the primary setup links to the nucleus in the suggested joke
    val newSecondaryRelationship : Column<String> = varchar("newSecondaryRelationship", length=32) // How the secondary setup links to the linguistic replacement in the suggested joke
}